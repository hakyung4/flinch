  ...
  return (
      <main className="max-w-2xl mx-auto px-4 py-12 text-gray-900">
        ...
        <div className="space-y-6 text-base leading-relaxed bg-white/70 p-6 rounded-xl shadow border border-orange-200">
          ...
          <h2 className="font-bold text-lg mt-6">1. Eligibility & Registration</h2>
          <ul className="list-disc ml-6">
            <li>You must be at least 13 years old to use Flinch.</li>
            <li>You are responsible for maintaining the confidentiality of your account information.</li>
          </ul>

          <h2 className="font-bold text-lg mt-6">2. User Content</h2>
          <ul className="list-disc ml-6">
          ...
          <h2 className="font-bold text-lg mt-6">3. Privacy</h2>
          <p>
            Your privacy is important to us. Please review our <Link href="/privacy" className="underline">Privacy Policy</Link> to understand how we collect, use, and safeguard your information.
          </p>

          <h2 className="font-bold text-lg mt-6">4. Acceptable Use</h2>
          <ul className="list-disc ml-6">
          ...
          <h2 className="font-bold text-lg mt-6">5. Modification & Termination</h2>
          <ul className="list-disc ml-6">
          ...
          <h2 className="font-bold text-lg mt-6">6. Disclaimer & Limitation of Liability</h2>
          <p>
          ...
          <h2 className="font-bold text-lg mt-6">7. Contact</h2>
          <p>
