  ...
  return (
      <main className="max-w-2xl mx-auto px-4 py-12 text-gray-900">
        ...
        <div className="space-y-6 text-base leading-relaxed bg-white/70 p-6 rounded-xl shadow border border-orange-200">
          ...
          <h2 className="font-bold text-lg mt-6">3. Sharing of Information</h2>
          <ul className="list-disc ml-6">
          ...
          <h2 className="font-bold text-lg mt-6">4. Data Security</h2>
          <p>
            We use industry-standard security measures to protect your data. However, no online service can be 100% secure.
          </p>

          <h2 className="font-bold text-lg mt-6">5. Your Choices</h2>
          <ul className="list-disc ml-6">
            <li>You may access or update your account information at any time.</li>
            <li>You may delete your account by contacting us at <Link className="underline" href="mailto:support@flinch.app">support@flinch.app</Link></li>
          </ul>

          <h2 className="font-bold text-lg mt-6">6. Changes to This Policy</h2>
          <p>
